...
public class OrderComposer {
     ...
     */) {
        ...
        this.mapper = mapper;
        this.orderServiceUrl = "http://ORDER-SERVICE/orderservice/";
        this.trackerServiceUrl = "http://TRACKER-SERVICE/tracker?orderId=";
    }
    ...
    public List<Tracker> getTracker(int id) {
        ...
        try {
            List<Tracker> trackers = restTemplate
                    .exchange(url, HttpMethod.GET, null, new ParameterizedTypeReference<List<Tracker>>() {
                    }).getBody();
